...
import { ChevronRight, Car, ClipboardList, Bell, LogOut, Gauge } from 'lucide-react'
import './Layout.css'
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            <div className="user-avatar">{usuario?.nome?.[0]?.toUpperCase() ?? 'U'}</div>
